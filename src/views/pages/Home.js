...
function Home() {
  return (
    <div>
      <section class="menu01 cid-rS4Rm4NvM4" once="menu" id="menu1-1m">
        <nav class="navbar navbar-dropdown beta-menu align-items-center navbar-fixed-top navbar-toggleable-sm">
          <div class="menu-bottom order-0 order-lg-1">
            <div class="menu-logo">
              <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap">
                  <a
                    href="index.html"
                    class="brand-link mbr-black mbr-bold display-5"
                  >
                    MedicalM4
                  </a>
                </span>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul
                class="navbar-nav nav-dropdown js-float-line"
              ...
              >
                ...
                <li class="nav-item dropdown">
                  <a
                    class="nav-link link mbr-black dropdown-toggle display-4"
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a
                      ...
                      href="headers.html"
                    >
                      Headers / Forms / Map / Clients / Tabs
                    </a>
                    <a
                      class="mbr-black dropdown-item display-4"
                      href="features.html"
                      aria-expanded="false"
                    >
                      Features / Pricing / Counters / Title
                    </a>
                    <a
                      class="mbr-black dropdown-item display-4"
                      href="team.html"
                      aria-expanded="false"
                    >
                      Team / Testimonials / Progress / Content
                    </a>
                    <a
                      class="mbr-black dropdown-item display-4"
                      ...
                      aria-expanded="false"
                    >
                      Accordions / Info / TimeLine / Footers
                    </a>
                  </div>
                </li>
              </ul>
              ...
              <div class="navbar-buttons mbr-section-btn">
                <a
                  ...
                  href="http://my.mobirise.com/buy.php?p=97"
                >
                  BUY NOW
                </a>
              </div>
      ...
      <section class="header1 cid-rS5p6jh4Gt mbr-fullscreen" id="header1-23">
        <div
          class="mbr-overlay"
          style={{ opacity: "0.6", backgroundColor: "rgb(255, 255, 255)" }}
        ></div>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <h1 class="mbr-section-title align-left mbr-fonts-style display-1">
                Welcome to the best <font color="#4f87fb">Dentistry</font>
                <br />
                in country.
              </h1>

              <div class="mbr-section-btn align-left  justify-content-center">
                <a
                  class="btn btn-lg btn-primary display-4"
                  href="https://mobirise.com"
                >
                  GET STARTED TODAY!
                </a>
                <a
                  class="content-link link mbr-bold display-4"
                  href="https://mobirise.com"
                >
                  <span class="mdi-action-favorite-outline mbr-iconfont"></span>
                  BETTER LIFE
                </a>
              </div>
            </div>
      ...
      <section class="features3 cid-rS5pauNwYv" id="features3-24">
        <div class="container">
          <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
              <div class="card-wrapper">
                <div class="card-img">
                  <div class="card-icon">
                    <span class="mbr-iconfont mdi-communication-contacts"></span>
                  </div>
                </div>
                <div class="card-box">
                  <h4 class="card-title pb-3 mbr-fonts-style mbr-bold display-7">
                    Most loved Dental Practice
                  </h4>
                  <p class="mbr-text mbr-fonts-style mbr-regular display-4">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
              <div class="card-wrapper">
                <div class="card-img">
                  <div class="card-icon">
                    <span class="mbr-iconfont mdi-action-restore"></span>
                  </div>
                </div>
                <div class="card-box ">
                  <h4 class="card-title pb-3 mbr-fonts-style mbr-bold display-7">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
              <div class="card-wrapper">
                <div class="card-img">
                  <div class="card-icon">
                    <span class="mbr-iconfont mdi-action-settings-phone"></span>
                  </div>
                </div>
                <div class="card-box">
                  <h4 class="card-title pb-3 mbr-fonts-style mbr-bold display-7">
      ...
      <section class="header04 cid-rS5pd4zZV5" id="header4-25">
        <div class="container-fluid">
          <div class="row align-items-center content-row">
            <div class="col-lg-6 wrap-block">
              <div class="contents">
                <h2 class="mbr-subtitle mbr-fonts-style mbr-bold display-4">
                  WHO WE ARE
                </h2>
                <h1 class="mbr-section-title mbr-fonts-style mbr-bold display-2">
                  The NY Biggest Dentistry
                </h1>
                <h3 class="mbr-section-text mbr-fonts-style mbr-bold boldSubtitle display-7">
                  New standard for patient care.
                </h3>
                <h4 class="mbr-section-text mbr-fonts-style mbr-light display-4">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Quisque a nisi faucibus, blandit nisl quis, ornare mauris.
                  Quisque facilisis gravida velit, quis tempus eros. Aenean quis
                  nisi consequat, elementum erat id, ultricies risus.
                </h4>
              </div>
              <div class="menu-content-right">
                <div class="wrap d-inline-block">
                  <div class="info-widget">
                    <img class="signature" src="../assets/images/14.jpg" />
                    <div class="widget-content display-4">
                      <p class="widget-title mbr-fonts-style mbr-bold display-7">
                        Howard Mason
                      </p>
            ...
            <div class="col-lg-6 photo-split">
              ...
              <div class="element-outer"></div>
              <div class="element-outer2"></div>
      ...
      <section
        class="carousel slide testimonials-slider features4 cid-rS5pexUnI7"
        data-interval="false"
        id="features4-26"
      >
        <div class="container text-center">
          <h3 class="mbr-section-subtitle mbr-fonts-style align-center mbr-bold display-4">
            OUR PHILOSOPHY
          </h3>
          ...
          <p class="mbr-text mbr-fonts-style align-center mbr-regular display-7">
            Leo duis ut diam quam nulla porttitor massa id neque. Sed risus
            pretium quam vulputate. Habitasse platea dictumst vestibulum rhoncus
              ...
              <div class="row justify-content-center">
                <div class="col-md-4">
                  <div class="card">
                    ...
                    <h4 class="mbr-fonts-style signature mbr-bold align-center display-7">
                      A softer touch
                    </h4>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-4 d-none d-md-block">
                  <div class="card">
                    ...
                    <div class="mbr-text mbr-fonts-style align-center card-text display-7">
                      If these are used improperly you could injure the gums
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section
        class="progress-bars-2 cid-rS5pfFTPPP mbr-parallax-background"
        id="progress-bars2-27"
      >
        <div
          class="mbr-overlay"
          style={{ opacity: " 0.9", backgroundColor: "rgb(79, 135, 251);" }}
        ></div>
        ...
        <div class="main container">
          <div class="row">
            <div class="row content-row col-lg-5">
              ...
              <h2 class="mbr-section-title mbr-fonts-style mbr-bold align-left display-2">
                Periodontal Therapy Skills.
              </h2>

              <div class="video-wrap d-flex align-items-center w-100 justify-content-center">
                <div
                  class="mbr-media show-modal align-center d-flex align-items-center"
              ...
              <div class="modalWindow-video-container">
                <div class="modalWindow-video">
                  <iframe
                    ...
                    frameborder="0"
                    allowfullscreen="1"
                    data-src="https://www.youtube.com/watch?v=J21qu_vspfg"
                  ></iframe>
                </div>
      ...
      <section class="tabs1 cid-rS5piqznFu" id="tabs1-28">
        <div class="container">
          <div class="top-part">
            <h3 class="mbr-section-subtitle mbr-fonts-style align-center mbr-bold display-4">
              OUR PHILOSOPHY
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item first">
                  <a
                    ...
                    aria-selected="true"
                  >
                    <span class="mdi-action-info-outline mbr-iconfont mbr-iconfont-btn"></span>
                    Metal Braces
                  </a>
                </li>
                <li class="nav-item">
                  <a
                    ...
                    aria-selected="true"
                  >
                    <span class="mdi-av-my-library-add mbr-iconfont mbr-iconfont-btn"></span>
                ...
                <li class="nav-item">
                  <a
                    ...
                    aria-selected="true"
                  >
                    <span class="mdi-image-healing mbr-iconfont mbr-iconfont-btn"></span>
                ...
                <li class="nav-item">
                  <a
                    ...
                    aria-selected="true"
                  >
                    <span class="mdi-action-swap-vert-circle mbr-iconfont mbr-iconfont-btn"></span>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <p class="mbr-text pt-4 mbr-fonts-style display-7">
                        ...
                        elit, sed do eiusmod tempor incididunt ut labore t
                        dolore magna aliqua. Ut enim ad minim veniam. Lorem
                        ipsum dolor sit amet, consectetur adipisicing elit, sed
                        do eiusmod tempor incididunt ut labore t dolore magna
                        aliqua.
                      </p>
      ...
      <section class="team1 cid-rS5pjNQkTm" id="team1-29">
        <div class="container">
          <h3 class="mbr-section-subtitle mbr-fonts-style align-center mbr-bold display-4">
            OUR TEAM
          </h3>

          <h2 class="mbr-fonts-style mbr-section-title mbr-bold display-2">
            Team to Brighten Your Smile
          </h2>
          <p class="mbr-text mbr-fonts-style align-center display-7">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
            eiusmod tempor incididunt ut labore t dolore magna aliqua.
          </p>
          <div class="row justify-content-center">
      ...
      <section class="info1 cid-rS5plfhIC6" id="info1-2a">
        <div
          class="mbr-overlay"
          style={{opacity: "0.8;", backgroundColor: "rgb(79, 135, 251);"}}
        ></div>
      ...
      <section
        class="carousel slide testimonials-slider testimonials2 cid-rS5pmOCWSb"
        id="testimonials2-2b"
      >
        <div
          class="mbr-overlay"
          style={{opacity: "0.9" , backgroundColor:" rgb(255, 255, 255)"}}
        ></div>
              ...
              <div class="carousel-item">
                <div class="col-md-12 col-lg-12">
                  ...
                  <p class="mbr-text mbr-regular align-center mbr-fonts-style box display-5">
                    ...
                    sed diam nonum nibhie euismod. Facilisis at vero eros et
                    accumsan et iusto odio dignissim.
                  </p>
                  <div class="author mbr-m-auto box">
                    <h3 class="mbr-bold pb-2 mbr-fonts-style display-7">
                      Roger Chapman
                    </h3>
                    <h4 class="mbr-semibold mbr-fonts-style display-4">
                      WELDER &amp; sweet-tooth
                    </h4>
                  </div>
                </div>
      ...
      <section class="extClients cid-rS5pnSo8RQ" id="clients1-2c">
        <div class="container-fluid">
      ...
      <section class="timeline1 cid-rSaha4EKqz" id="timeline1-4g">
        <div class="container align-center">
          <h3 class="mbr-subtitle mbr-fonts-style mbr-bold display-4">
            WHO WE ARE
          </h3>
          <h1 class="mbr-section-title mbr-fonts-style mbr-bold display-2">
            The NY Central Dentistry
          </h1>
          ...
          <div class="timelines-container" mbri-timelines="">
            <div class="row timeline-element first-separline separline">
              ...
              <div class="date col-xs-12 col-md-2">
                <p class="mbr-timeline-date mbr-fonts-style display-7">2010</p>
              </div>
              ...
              <div class="col-xs-12 col-md-7">
                <div class="timeline-text-content">
                  ...
                  <p class="mbr-timeline-text mbr-fonts-style display-7">
                    ...
                    erat libero, bibendum in libero tempor, luctus volutpat
                    ligula. Integer fringilla porttitor pretium. Nam erat felis,
                    iaculis id justo ut, ullamcorper feugiat elit. Proin vel
                    lectus auctor, porttitor ligula vitae, convallis leo. In
                    eget massa elit.
                  </p>
                </div>
              </div>
            ...
            <div class="row timeline-element  separline">
              ...
              <div class="date col-xs-12 col-md-2">
                <p class="mbr-timeline-date mbr-fonts-style display-7">2011</p>
              </div>
              <span class="iconBackground"></span>
              <div class="col-xs-12 col-md-7">
                <div class="timeline-text-content">
                  <h4 class="mbr-timeline-title mbr-fonts-style display-5">
                    The new part of Dentistry
                  </h4>
                  <p class="mbr-timeline-text mbr-fonts-style display-7">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
                    erat libero, bibendum in libero tempor, luctus volutpat
            ...
            <div class="row timeline-element">
              ...
              <div class="date col-xs-12 col-md-2">
                <p class="mbr-timeline-date mbr-fonts-style display-7">2012</p>
              </div>
              <span class="iconBackground"></span>
              <div class="col-xs-12 col-md-7">
                <div class="timeline-text-content">
                  <h4 class="mbr-timeline-title mbr-fonts-style display-5">
                    Opening of the US Institute of Dentistry
                  </h4>
                  <p class="mbr-timeline-text mbr-fonts-style display-7">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
                    erat libero, bibendum in libero tempor, luctus volutpat
      ...
      <section class="mbr-section form2 cid-rS5pu3geqe" id="form2-2e">
        <div class="container">
          <div class="row py-2 justify-content-center">
            <div class="col-lg-4">
              <div class="brand">
                ...
                <span class="caption-wrap">
                  <a
                    href="https://mobirise.com"
                    class="brand-link mbr-white mbr-bold display-2"
                  >
                    MedicalM4
                  </a>
                </span>
            ...
            <form action="https://mobirise.com/" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="7ZT2cR1vI9wVDRfSfP1x1jptq+ZVHvW7Dsozs7iIu7ESzHXYZ8KJgEXz8d7cOf+54mioImvlyxwN1Ylcwab1J2p82M3osyElCNp1Cg3vcdW3rDchJJevDs1u1h9bKPrU">
                <div class="form-row"/>
                ...
                <div class="dragArea form-row">
                    <div class="col form-group " data-for="email">
                        <input type="email" name="email" placeholder="Your email address" data-form-field="Email" required="required" class="form-control display-7" id="email-form2-2e"/>
                    </div>
      ...
      <section class="footer1 cid-rS5puRAWgh" id="footer1-2f">
        <div class="container">
          <div class="media-container-row content text-white">
              ...
              <div class="item">
                ...
                <div class="card-box">
                  <h4 class="item-title align-left mbr-fonts-style display-4">
                    Address: 7654 Street Name
                  </h4>
                </div>
              </div>
              <div class="item">
                <div class="card-img">
                  <span class="mbr-iconfont img1 mdi-communication-phone"></span>
                </div>
                <div class="card-box">
                  <h4 class="item-title align-left mbr-fonts-style display-4">
                    Phone: +(999) 5554432
            ...
            <div class="col-12 col-md-6 col-lg-3">
              ...
              <div class="link">
                ...
                <div class="card-box">
                  <h4 class="link-title align-left mbr-fonts-style display-4">
                    <a
                      href="https://mobirise.com/"
                      class="text-white mbr-fonts-style"
                    >
                      About Us
                    </a>
                  </h4>
              ...
              <div class="link">
                ...
                <div class="card-box">
                  <h4 class="link-title align-left mbr-fonts-style display-4">
                    <a href="https://mobirise.com/" class="text-white">
                      Company
                    </a>
                  </h4>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
              ...
              <div class="box-list mbr-fonts-style display-4">
                <li class="clearfix">
                  Mon - Tue<span>11.00 - 19.00</span>
                </li>
                <li class="clearfix">
                  Wed - Thur<span>09.30 - 16.30</span>
                </li>
                <li class="clearfix">
                  Fri - Sat<span>11.30 - 20.00</span>
                </li>
                <li class="clearfix">
                  Saturday<span>10.30 - 12.00</span>
                </li>
                <li class="clearfix">
      ...
      <section class="footer2 cid-rS5pv8zcF8" id="footer2-2g">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              <p class="mbr-text links mbr-fonts-style display-4">
                © Copyright 2020 <a href="https://mobirise.com/">Mobirise</a> -
                All Rights Reserved
              </p>
            </div>
          </div>
